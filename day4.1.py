...
for sleep in guards[mostTimeId]:
    start = sleep.begin
    end = sleep.end
    while start < end:
        minutes[start] += 1
...
for minute in minutes:
    if minutes[minute] > largestCount:
        largestCount = minutes[minute]
        largestMinute = minute

print('Guard id:', mostTimeId)
print('Minute:', largestMinute)
print('Multi:', mostTimeId * largestMinute) # answer 63509
